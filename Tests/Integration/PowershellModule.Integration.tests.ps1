...
$script:dscResourceFriendlyName = 'PowershellModule'
...
try
{
    ...
    Describe "$($script:dcsResourceName)_Integration" -Tag Integration {
        $configurationName = "$($script:dcsResourceName)_InstallModule_Config"
        ...
        Context ('When using configuration {0}' -f $configurationName) {
            ...
            It 'Should have set the resource and all the parameters should match' {
                $resourceCurrentState = $script:currentConfiguration | Where-Object -FilterScript {
                    ...
                    -and $_.ResourceId -eq "[$($script:dscResourceFriendlyName)]InstallModule"
                }

                $resourceCurrentState.Ensure | Should -Be 'Present'
                $resourceCurrentState.RequiredVersion | Should -Be '2.21.0.0'
        ...
        $configurationName = "$($script:dcsResourceName)_RemoveModule_Config"
        ...
        Context ('When using configuration {0}' -f $configurationName) {
            ...
            It 'Should have set the resource and all the parameters should match' {
                $resourceCurrentState = $script:currentConfiguration | Where-Object -FilterScript {
                    $_.ConfigurationName -eq $configurationName `
                    -and $_.ResourceId -eq "[$($script:dscResourceFriendlyName)]RemoveModule"
                }
